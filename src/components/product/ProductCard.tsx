          ...
          >
            <Heart
              className={cn(
                ...
                isInWishlist ? 'fill-error text-error' : 'text-foreground-muted',
              )}
            />
          </button>
        )}
        ...
        <div className="mt-auto pt-2">
          {firstVariant ? (
            <div className="flex items-baseline gap-2">
              ...
              {firstVariant.comparePrice && firstVariant.comparePrice > firstVariant.price && (
            ...
            <span className="text-sm text-foreground-muted">Harga tidak tersedia</span>
          )}
        </div>
      </div>
    </Link>
